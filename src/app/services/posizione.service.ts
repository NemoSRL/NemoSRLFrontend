...
export class PosizioneService {
  ...
  public addPosizione(posizione:Posizione):Observable<Posizione>{
    return this.httpClient.post<Posizione>(`${this.apiUrl}/${ADD_POSIZIONE}`,posizione)
  }

  public getAllPosizioni(): Observable<Posizione[]>{
    return this.httpClient.get<Posizione[]>(`${this.apiUrl}/${GET_ALL_POSIZIONI}`)
  }
  ...
  public updatePosizione(posizione:Posizione):Observable<Object>{
    return this.httpClient.put<object>(`${this.apiUrl}/${UPDATE_POSIZIONE}`,posizione)
  }

  public deletePosizione(id:id):Observable<Posizione>{
    return this.httpClient.delete<Posizione>(`${this.apiUrl}/${DELETE_POSIZIONE}/${id}`)
  }
}
